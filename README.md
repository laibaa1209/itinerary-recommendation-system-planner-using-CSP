# this is the main/ home page of itineary planner
<img width="1877" height="884" alt="image" src="https://github.com/user-attachments/assets/12c71eb4-89aa-4bbd-ab0b-9cdb74fadc82" />
# sign in page
<img width="1902" height="884" alt="image" src="https://github.com/user-attachments/assets/bb52e7d6-61b1-4032-b8b8-7a8af516d479" />
# signup 
<img width="598" height="850" alt="image" src="https://github.com/user-attachments/assets/1a41d4eb-4cf4-4e0f-9b91-fffebe1f3dee" />
# editing ur traveler type:
<img width="477" height="229" alt="image" src="https://github.com/user-attachments/assets/36d0fc46-d7c2-49c8-9870-68c7daf50f1b" />
# u will build your itineary here,
<img width="1889" height="853" alt="image" src="https://github.com/user-attachments/assets/2363563d-2e21-4e4c-be5c-a66de3f9b14c" />
# select citiy you want to travel, dates of your trip, max activites and start time of your day, and once u select the cities according to those cities it will show u the activties u can do there:
<img width="1877" height="292" alt="image" src="https://github.com/user-attachments/assets/e27d961c-85c2-46c4-bd7a-0a2829ac4151" />
# u can find activites based on categroes
<img width="307" height="446" alt="image" src="https://github.com/user-attachments/assets/c6b8acec-a5da-4162-924d-e1790bd167ad" />
# selecting a category for the same place hunza and see how it filters out activties:
<img width="1678" height="210" alt="image" src="https://github.com/user-attachments/assets/cefd8156-5190-4839-b8da-ed087d77b790" />
# to select activites, click the check box and press create itineary, also set the budget
<img width="1709" height="853" alt="image" src="https://github.com/user-attachments/assets/84d474b9-444e-4162-b99f-b9b386f094bd" />
# here all your itinearies will be shown:
<img width="1908" height="395" alt="image" src="https://github.com/user-attachments/assets/a42f303e-69e6-4259-86a9-52a652b225fe" />
## you can view your generated itineary here, auto plan, auto plans your rest days based on that place itineary and similar interest, and manage budet and expenses shows the track down of your money
<img width="1897" height="857" alt="image" src="https://github.com/user-attachments/assets/9624a73c-fb85-45cf-9a04-6f2d2255a900" />
# this is the budget page which tracks down eveeything, you can add extra manual expnses like renting a cra or spending money on food and it will keep calculting and also add those budget to our database and it will be visible to u:
<img width="1858" height="869" alt="image" src="https://github.com/user-attachments/assets/8c40f158-e513-4477-86a1-dc78b6c5b823" />
# after adding manual expense:
<img width="548" height="142" alt="image" src="https://github.com/user-attachments/assets/ec20b03d-76b4-4989-bdba-484c28bcf713" />
<img width="1870" height="876" alt="image" src="https://github.com/user-attachments/assets/b3ff6b56-cc80-4b10-9145-dc45e305218f" />
# here u will tell it wether ur a new user or an old user based on that and interest it will recommnd u places to visit and it also shows the rating of each and every city:
<img width="1900" height="863" alt="image" src="https://github.com/user-attachments/assets/ba150c89-f9ae-4372-b49a-e982ae693576" />
# recommended plcaes:
<img width="1796" height="750" alt="image" src="https://github.com/user-attachments/assets/b53c78cc-f099-4eca-b94b-37fe79dd5eae" />
# here u can write your reviews for the city:
<img width="1879" height="860" alt="image" src="https://github.com/user-attachments/assets/f9d00136-8be8-40a1-b31b-387f3c62a6f2" />
<img width="649" height="224" alt="image" src="https://github.com/user-attachments/assets/a6ce7de1-4a19-4268-a50b-60f253fbbe0e" />
# ur profile is visible from here, you can also upload pictures of ur trip and it will be saved in database:
<img width="1804" height="641" alt="image" src="https://github.com/user-attachments/assets/a1c6986b-8933-4fb0-bd3c-20fb8e4c102e" />
# and finally....:
<img width="1908" height="875" alt="image" src="https://github.com/user-attachments/assets/f2c3aa0b-765e-46c4-a52c-190bd16e7a39" />



# 🗺️ Itinerary Planner Project
